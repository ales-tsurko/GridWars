...
public class KeyDataDefaults : ScriptableObject {
    public List<KeyData> keyData = new List<KeyData>() {
        new KeyData(){code = "Tank1", description = "Player 1 Tank", key = KeyCode.F, playerNum = 1},
        new KeyData(){code = "Chopper1", description = "Player 1 Chopper", key = KeyCode.J, playerNum = 1},
        new KeyData(){code = "Tanker1", description = "Player 1 Tanker", key = KeyCode.D, playerNum = 1},
        ...
        new KeyData(){code = "Chopper2", description = "Player 2 Chopper", key = KeyCode.U, playerNum = 2},
        new KeyData(){code = "Tanker2", description = "Player 2 Tanker", key = KeyCode.E, playerNum = 2},
        new KeyData(){code = "MobileSAM2", description = "Player 2 Mobile Sam", key = KeyCode.I, playerNum = 2}
    };

    public List<KeyData> joyData = new List<KeyData>() {
        new KeyData(){ code = "Tank1", description = "Player 1 Tank", key = KeyCode.Joystick1Button0, playerNum = 1 },
        new KeyData(){ code = "Chopper1", description = "Player 1 Chopper", key = KeyCode.Joystick2Button1, playerNum = 1 },
        new KeyData(){ code = "Tanker1", description = "Player 1 Tanker", key = KeyCode.Joystick1Button2, playerNum = 1 },
        ...
        new KeyData(){ code = "Tank2", description = "Player 2 Tank", key = KeyCode.Joystick2Button0, playerNum = 2 },
        new KeyData(){ code = "Chopper2", description = "Player 2 Chopper", key = KeyCode.Joystick2Button1, playerNum = 2 },
        new KeyData(){ code = "Tanker2", description = "Player 2 Tanker", key = KeyCode.Joystick2Button2, playerNum = 2 },
