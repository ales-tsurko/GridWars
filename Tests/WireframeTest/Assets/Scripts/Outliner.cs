...
public class Outliner : MonoBehaviour {
	...
	public float pushOutWidth = 0.1f;
	...
	List <Vector3> TriangleVerticesForLineAndNormal(Vector3 p1, Vector3 p2, Vector3 normal) {
		...
		Vector3 v1 = p1 + right; // top right
		Vector3 v2 = p1 - right; // top left
		Vector3 v3 = p2 + right; // bottom right
		Vector3 v4 = p2 - right; // bottom left
