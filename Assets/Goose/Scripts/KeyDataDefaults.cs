...
public class KeyDataDefaults : ScriptableObject {
    public List<KeyData> keyData = new List<KeyData>() {
		...
		new KeyData(){ code = "MobileSAM2", description = "Mobile Sam", key = KeyCode.E, playerNum = 2 },
		new KeyData(){ code = "Tank2", description = "Tank", key = KeyCode.R, playerNum = 2 },
		new KeyData(){ code = "Tanker2", description = "Tanker", key = KeyCode.U, playerNum = 2 },
		new KeyData(){ code = "Chopper2", description = "Chopper", key = KeyCode.I, playerNum = 2 },
        ...
        new KeyData(){code = "Back", description = "Exit First Person View", key = KeyCode.Escape, playerNum = 1 }
    };
    ...
    public List<KeyData> joyData = new List<KeyData>() {
		...
		new KeyData(){ code = "Back", description = "Exit First Person View", key = KeyCode.Joystick1Button2, playerNum = 1 }
    };
