...
public class KeyDataDefaults : ScriptableObject {
    public List<KeyData> keyData = new List<KeyData>() {
		...
		new KeyData(){ code = Keys.EXIT, description = "Exit First Person View", key = KeyCode.Escape, playerNum = 1 },
    ...
    public List<KeyData> joyData = new List<KeyData>() {
		...
		new KeyData(){ code = Keys.EXIT, description = "Exit First Person View", key = KeyCode.Joystick1Button9, playerNum = 1 },
